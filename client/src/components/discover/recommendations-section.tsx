...
export default function RecommendationsSection({ 
  ...
  if (isLoading) {
    return (
      <div className="py-8">
        <h2 className="text-xl font-semibold mb-4">Finding matches for you...</h2>
        <div className="flex space-x-4 overflow-x-auto pb-2">
          {[1, 2, 3].map((i) => (
            <Card key={i} className="w-[300px] min-w-[300px] flex-shrink-0 animate-pulse">
              <CardHeader className="pb-2">
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-full bg-gray-200 mr-3"></div>
                  <div>
                    <div className="h-4 bg-gray-200 rounded w-[120px] mb-2"></div>
                    <div className="h-3 bg-gray-100 rounded w-[80px]"></div>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
  ...
  if (!recommendations || recommendations.length === 0) {
    return (
      <div className="py-6 text-center">
        <div className="bg-primary bg-opacity-10 p-4 rounded-full inline-block mb-3">
...
function RecommendationCard({ 
  ...
  return (
    <Card className="w-[300px] min-w-[300px] flex-shrink-0 glass-card hover:shadow-md transition-all">
      <CardHeader className="pb-2">
        <div className="flex items-center">
